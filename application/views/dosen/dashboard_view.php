                ...
                <div class="span6">
                    <div class="well">
                        <ul class="nav nav-list">
                            ...
                            <li><a href="<?php echo site_url('dosen/list_problems/active'); ?>">List All Active Problems</a></li>
                            <li><a href="<?php echo site_url('dosen/list_problems/inactive'); ?>">List All Inctive Problems</a></li>
