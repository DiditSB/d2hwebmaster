...
*/
	...
	*/
	 ...
	 * Table used to hold profile data on each user.
	 *
	*/ 
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'upro_name','upro_phone','upro_nomor_induk'
	);
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('uacc_email', 'uacc_username', 'upro_name', 'upro_nomor_induk');
	...
	*/
	$config['security']['static_salt'] = '$eCur3-mE!';
	...
	*/
	$config['security']['recaptcha_public_key']	= '6Ldgj-MSAAAAAFWTiIXu6QYxivJ9mo0UmC4a6N3h';
	$config['security']['recaptcha_private_key'] = '6Ldgj-MSAAAAACPF7PAf-Yhy3mtF1MRogVn8i9m1'; 
