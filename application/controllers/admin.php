...
class Admin extends CI_Controller {
    ...
    function insert_privilege() {
        ...
        if ($this->input->post('insert_privilege')) {
            ...
            $this->admin_model->insert_privilege();
        }

        // Set any returned status/error messages.
        $this->data['message'] = (!isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];

        $this->load->view('admin/insert_privilege_view', $this->data);
    }
    ...
    function insert_user_group() {
        ...
        if ($this->input->post('insert_user_group')) {
            $this->load->model('admin_model');
            $this->admin_model->insert_user_group();
        }

        // Set any returned status/error messages.
        $this->data['message'] = (!isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];

        $this->load->view('admin/user_group_insert_view', $this->data);
    }
    ...
    function list_user_status($status = FALSE) {
        ...
        if ($this->input->post('update_list_user_status') && $this->flexi_auth->is_privileged('Update Users') && $status == 'active') {
            $this->load->model('admin_model');
            $this->admin_model->update_active_user();
        }

        if ($this->input->post('update_list_user_status') && $this->flexi_auth->is_privileged('Update Users') && $status == 'inactive') {
            $this->load->model('admin_model');
            $this->admin_model->update_inactive_user();
        }
...
//        if (!$this->flexi_auth->in_group('Admin')) {
...
//        }
    ...
    function delete_unactivated_users() {
        ...
        if ($this->input->post('delete_unactivated') && $this->flexi_auth->is_privileged('Delete Users')) {
            $this->load->model('admin_model');
            $this->admin_model->delete_users($inactive_days);
        }
        ...
        $this->load->view('admin/users_unactivated_view', $this->data);
    }
...
//        }
    ...
    function manage_privileges() {
        ...
        if ($this->input->post('delete_privilege') && $this->flexi_auth->is_privileged('Delete Privileges')) {
            $this->load->model('admin_model');
            $this->admin_model->manage_privileges();
        }
        ...
        $this->load->view('admin/privileges_view', $this->data);
    }
    ...
    function manage_user_accounts() {
        ...
        if ($this->input->post('search_users') && $this->input->post('search_query')) {
            ...
            redirect('admin/manage_user_accounts/search/' . $search_query . '/page/');
        }
        // If 'Manage User Accounts' form has been submitted and user has privileges to update user accounts, then update the account details.
            ...
            $this->admin_model->update_user_accounts();
        }

        // Get user account data for all users. 
        // If a search has been performed, then filter the returned users.
        $this->admin_model->get_user_accounts();

        // Set any returned status/error messages.
        $this->data['message'] = (!isset($this->data['message'])) ? $this->session->flashdata('message') : $this->data['message'];

        $this->load->view('admin/user_acccounts_view', $this->data);
    }
    ...
    function manage_user_groups() {
        ...
        if ($this->input->post('delete_group') && $this->flexi_auth->is_privileged('Delete User Groups')) {
            $this->load->model('admin_model');
            $this->admin_model->manage_user_groups();
        }
        ...
        $this->load->view('admin/manage_user_groups_view', $this->data);
    }
    ...
    function update_group_privileges($group_id) {
        ...
        $this->load->view('admin/user_group_privileges_update_view', $this->data);
    }
    ...
    function update_privilege($privilege_id) {
        ...
        if ($this->input->post('update_privilege')) {
            $this->load->model('admin_model');
            $this->admin_model->update_privilege($privilege_id);
        }
        ...
        $this->load->view('admin/privilege_update_view', $this->data);
    }
    ...
    function update_user_account($user_id) {
        ...
        if ($this->input->post('update_users_account')) {
            $this->load->model('admin_model');
            $this->admin_model->update_user_account($user_id);
        }
        ...
        $this->load->view('admin/user_account_update_view', $this->data);
    }
    ...
    function update_user_group($group_id) {
        ...
        if ($this->input->post('update_user_group')) {
            $this->load->model('admin_model');
            $this->admin_model->update_user_group($group_id);
        }
        ...
        $this->load->view('admin/user_group_update_view', $this->data);
    }
    ...
    function update_user_privileges($user_id) {
        ...
        if ($this->input->post('update_user_privilege')) {
            $this->load->model('admin_model');
            $this->admin_model->update_user_privileges($user_id);
        }
        ...
        $this->load->view('admin/user_privileges_update_view', $this->data);
    }
